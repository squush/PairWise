...
event_1 = Event.create!(location: "Scarborough", date: "2022-12-02", rounds: 6)
event_2 = Event.create!(location: "Hochelaga", date: "2022-12-02", rounds: 8)
...
Matchup.create!(round_number: 3, player1: player_2c, player2: player_2b, player1_score: 401, player2_score: 390, done: true)
...
Matchup.create!(round_number: 5, player1: player_2b, player2: player_2d, player1_score: 387, player2_score: 390, done: true)
